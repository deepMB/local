...
def planner(state: AgentState) -> AgentState:
    ...
    try:
        ...
        fallback_plan = {
            ...
            "description": "Execute the given task using available tools",
            "steps": [
                {
                    "id": "step_1",
                    "name": "Task Analysis",
                    "objective": "Analyze the task and determine required actions",
                    "success_criteria": "Clear understanding of what needs to be done"
                },
                {
                    "id": "step_2", 
                    "name": "Task Execution",
                    "objective": "Complete the task using appropriate tools",
